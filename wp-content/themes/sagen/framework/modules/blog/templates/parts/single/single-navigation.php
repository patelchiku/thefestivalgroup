<?php
$blog_single_navigation = sagen_select_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = sagen_select_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
			...
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						...
						'label' => '<span class="qodef-blog-single-nav-label">'.esc_html__('previous', 'sagen').'</span>'
					),
					'next' => array(
						'mark' => '<span class="qodef-blog-single-nav-mark ion-ios-arrow-thin-right"></span>',
						'label' => '<span class="qodef-blog-single-nav-label">'.esc_html__('next', 'sagen').'</span>'
					)
				);
