<?php
namespace SagenCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'sagen' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Standard', 'sagen' ) => 'standard',
							esc_html__( 'Boxed', 'sagen' )    => 'boxed',
							esc_html__( 'Masonry', 'sagen' )  => 'masonry',
							esc_html__( 'Simple', 'sagen' )   => 'simple',
							esc_html__( 'Minimal', 'sagen' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
					...
					array(
						...
						'heading'    => esc_html__( 'Number of Columns', 'sagen' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Space Between Items', 'sagen' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'sagen' ),
						'description' => esc_html__( 'Number of words', 'sagen' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'sagen' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'sagen' ),
						'value'      => array_flip( sagen_select_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'sagen' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'sagen' ),
						'value'      => array_flip( sagen_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'sagen' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'sagen' ),
						'value'      => array_flip( sagen_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'sagen' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'sagen' ),
						'value'      => array(
							esc_html__( 'None', 'sagen' )            => 'no-pagination',
							esc_html__( 'Standard', 'sagen' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'sagen' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'sagen' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'sagen' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		sagen_select_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
