...
if ( ! function_exists('sagen_select_contact_form_7_options_map') ) {

	function sagen_select_contact_form_7_options_map() {
		
		sagen_select_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'sagen' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = sagen_select_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'sagen' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = sagen_select_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'sagen' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'sagen' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'sagen' ),
		));
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'sagen' ),
			)
		);
		...
		$typography_text_row2 = sagen_select_add_admin_row(
			array(
		...
		$typography_text_row3 = sagen_select_add_admin_row(
			array(
		...
		$typography_label_group = sagen_select_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'sagen' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'sagen' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = sagen_select_add_admin_row(
			array(
		...
		$typography_label_row2 = sagen_select_add_admin_row(
			array(
		...
		$background_border_group = sagen_select_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'sagen' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'sagen' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'sagen' )
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'sagen' )
			)
		);
		
		$background_border_row2 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'sagen' ),
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'sagen' )
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'sagen' )
			)
		);
		
		$background_border_row3 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = sagen_select_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'sagen' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = sagen_select_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = sagen_select_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'sagen' ),
				'description' => esc_html__( 'Setup form elements margin', 'sagen' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = sagen_select_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'sagen' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'sagen' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = sagen_select_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'sagen' ),
				'description' => esc_html__( 'Setup button text typography', 'sagen' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = sagen_select_add_admin_row(
			array(
		...
		$button_typography_row2 = sagen_select_add_admin_row(
			array(
		...
		$button_background_border_group = sagen_select_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'sagen' ),
				'description' => esc_html__( 'Setup button background and border style', 'sagen' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'sagen' )
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'sagen' )
			)
		);
		
		$button_background_border_row2 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'sagen' )
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'sagen' )
			)
		);
		
		$button_background_border_row3 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'sagen' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'sagen' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = sagen_select_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'sagen')
		));

		//Text Typography

		$typography_text_group = sagen_select_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'sagen'),
			'description'	=> esc_html__('Setup typography for form elements text', 'sagen'),
		...
		$typography_text_row1 = sagen_select_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = sagen_select_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = sagen_select_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = sagen_select_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'sagen'),
			'description'	=> esc_html__('Setup typography for form elements label', 'sagen'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = sagen_select_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = sagen_select_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = sagen_select_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'sagen'),
			'description'	=> esc_html__('Setup form elements background and border style', 'sagen'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = sagen_select_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = sagen_select_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = sagen_select_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = sagen_select_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'sagen'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = sagen_select_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = sagen_select_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'sagen'),
			'description'	=> esc_html__('Setup form elements margin', 'sagen'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = sagen_select_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = sagen_select_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'sagen'),
			'description'	=> esc_html__('Setup button text typography', 'sagen'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = sagen_select_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = sagen_select_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = sagen_select_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'sagen'),
			'description'	=> esc_html__('Setup button background and border style', 'sagen'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = sagen_select_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = sagen_select_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = sagen_select_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = sagen_select_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'sagen')
        ));
        ...
        $typography_label_row3 = sagen_select_add_admin_row(array(
        ...
        $button_typography_row3 = sagen_select_add_admin_row(array(
	...
	add_action( 'sagen_select_action_options_map', 'sagen_select_contact_form_7_options_map', sagen_select_set_options_map_position( 'contact_form_7' ) );
}