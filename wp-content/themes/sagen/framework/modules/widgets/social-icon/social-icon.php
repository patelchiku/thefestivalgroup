...
if ( class_exists( 'SagenCoreClassWidget' ) ) {
	class SagenSelectClassSocialIconWidget extends SagenCoreClassWidget {
		
		public function __construct() {
			parent::__construct(
				'qodef_social_icon_widget',
				esc_html__( 'Sagen Social Icon Widget', 'sagen' ),
				array( 'description' => esc_html__( 'Add social network icons to widget areas', 'sagen' ) )
			);
			...
			$this->params = array_merge(
				array(
					array(
						'type'        => 'dropdown',
						'name'        => 'icon_text',
						'title'       => esc_html__( 'Display Icon or Text', 'sagen' ),
						'description' => esc_html__( 'Choose whether you want to display social icon or text instead', 'sagen' ),
						'options'     => array(
							'icon' => esc_html__( 'Icon', 'sagen' ),
							'text' => esc_html__( 'Text', 'sagen' )
						)
					),
					array(
						'type'        => 'textfield',
						'name'        => 'social_text',
						'title'       => esc_html__( 'Social Text', 'sagen' ),
						'description' => esc_html__( 'Instert text which will describe desired social network', 'sagen' )
					)
				),
				sagen_select_icon_collections()->getSocialIconWidgetParamsArray(),
				array(
					array(
						'type'  => 'textfield',
						'name'  => 'link',
