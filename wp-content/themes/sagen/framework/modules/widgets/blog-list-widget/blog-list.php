...
if ( class_exists( 'SagenCoreClassWidget' ) ) {
	class SagenSelectClassBlogListWidget extends SagenCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_blog_list_widget',
				esc_html__( 'Sagen Blog List Widget', 'sagen' ),
				array( 'description' => esc_html__( 'Display a list of your blog posts', 'sagen' ) )
			);
			...
			$this->params = array(
				...
				array(
					...
					'options' => array(
						...
						'minimal' => esc_html__( 'Minimal', 'sagen' )
					)
				),
				array(
					'type'  => 'textfield',
					'name'  => 'number_of_posts',
					'title' => esc_html__( 'Number of Posts', 'sagen' )
				),
				array(
					'type'    => 'dropdown',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'orderby',
					'title'   => esc_html__( 'Order By', 'sagen' ),
					'options' => sagen_select_get_query_order_by_array()
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'order',
					'title'   => esc_html__( 'Order', 'sagen' ),
					'options' => sagen_select_get_query_order_array()
				),
				array(
					'type'        => 'textfield',
					'name'        => 'category',
					'title'       => esc_html__( 'Category Slug', 'sagen' ),
					'description' => esc_html__( 'Leave empty for all or use comma for list', 'sagen' )
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'title_tag',
				...
				array(
					...
					'title'   => esc_html__( 'Title Text Transform', 'sagen' ),
		...
		public function widget( $args, $instance ) {
			...
			echo '<div class="widget qodef-blog-list-widget" ' . sagen_select_get_inline_style( $widget_styles ) . '>';
