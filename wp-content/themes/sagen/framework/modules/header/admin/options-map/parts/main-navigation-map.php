...
if ( ! function_exists( 'sagen_select_get_hide_dep_for_header_main_menu_options' ) ) {
	function sagen_select_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'sagen_select_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'sagen_select_header_main_navigation_options_map' ) ) {
	function sagen_select_header_main_navigation_options_map() {
		$hide_dep_options = sagen_select_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = sagen_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'sagen' ),
		...
		sagen_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'sagen' )
			)
		);
		...
		$drop_down_group = sagen_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'sagen' )
			)
		);
		
		$drop_down_row1 = sagen_select_add_admin_row(
			array(
		...
		sagen_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'sagen' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'sagen' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'sagen' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'sagen' )
				)
			)
		);
		...
		$first_level_group = sagen_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'sagen' )
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'sagen' ),
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'sagen' ),
			)
		);
		
		$first_level_row4 = sagen_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'sagen' ),
			)
		);
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'sagen' ),
			)
		);
		
		$first_level_row5 = sagen_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = sagen_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = sagen_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		sagen_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'sagen' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = sagen_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'sagen' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'sagen' )
			)
		);
		...
		$second_level_wide_group = sagen_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'sagen' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'sagen' )
			)
		);
		
		$second_level_wide_row1 = sagen_select_add_admin_row(
			array(
		...
		$second_level_wide_row2 = sagen_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = sagen_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = sagen_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'sagen' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'sagen' )
			)
		);
		...
		$third_level_wide_group = sagen_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'sagen' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'sagen' )
			)
		);
		
		$third_level_wide_row1 = sagen_select_add_admin_row(
			array(
		...
		$third_level_wide_row2 = sagen_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = sagen_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'sagen_select_action_header_main_navigation_options_map', 'sagen_select_header_main_navigation_options_map', 10, 1 );
}