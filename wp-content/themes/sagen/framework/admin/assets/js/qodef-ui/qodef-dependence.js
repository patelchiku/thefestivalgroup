			...
			$.each(items, function (key, value) {
				...
				if (optionName === key) {
					...
					switch (otherOptionType) {
						case 'checkbox':
							otherValue = $('.qodef-dependency-option[data-option-name="' + key + '"]').find('input[type="hidden"][name="' + key + '"]').val();
							break;
						case 'selectbox':
							otherValue = $('.qodef-dependency-option[data-option-name="' + key + '"]').val();
							break;
					}
