...
$show_related_posts = sagen_select_options()->getOptionValue('property_single_related_posts') == 'yes' ? true : false;

$post_id = get_the_ID();
$related_posts = sagen_core_get_property_single_related_posts($post_id);
?>
	                ...
	                while ( $related_posts->have_posts() ) : $related_posts->the_post(); ?>
                        <div class="qodef-ps-related-post">
	                        ...
	                        <div class="qodef-ps-related-text">
		                        ...
		                        <?php $categories = wp_get_post_terms($post_id, 'property-category'); ?>
