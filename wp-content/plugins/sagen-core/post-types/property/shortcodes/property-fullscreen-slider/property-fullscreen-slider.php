...
class PropertyFullScreenSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Sagen Property Fullscreen Slider', 'sagen-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
                            ...
                            'value'       => array(
                                esc_html__( 'Light', 'sagen-core') => 'qodef-pfs-light-skin',
                                esc_html__( 'Dark', 'sagen-core') => 'qodef-pfs-dark-skin'
                            )
                        ),
						array(
							'type'        => 'autocomplete',
	...
	public function render( $atts, $content = null ) {
        ...
        $customNavigation .= '<span class="qodef-pfs-custom-nav-prev">' . esc_html__('Previous Project','sagen-core') . '</span>';
        $customNavigation .= '<span class="qodef-pfs-custom-nav-next">' . esc_html__('Next Project','sagen-core') . '</span>';
