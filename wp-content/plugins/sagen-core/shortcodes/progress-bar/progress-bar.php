<?php
namespace SagenCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar', 'sagen-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Percentage Type', 'sagen-core' ),
							'value'      => array(
								esc_html__( 'Default', 'sagen-core' )  => '',
								esc_html__( 'Floating', 'sagen-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'sagen-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'sagen-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		wp_enqueue_script( 'counter', SAGEN_CORE_SHORTCODES_URL_PATH . '/progress-bar/assets/js/plugins/counter.js', array( 'jquery' ), false, true );
		
		$html = sagen_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
