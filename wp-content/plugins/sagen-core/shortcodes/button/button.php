<?php
namespace SagenCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'sagen-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									...
									esc_html__( 'Simple', 'sagen-core' )  => 'simple'
								),
								'admin_label' => true
							),
							array(
								...
								'value'      => array(
									...
									esc_html__( 'Small', 'sagen-core' )   => 'small',
							...
							array(
								...
								'value'       => esc_html__( 'Button Text', 'sagen-core' ),
								'save_always' => true,
								'admin_label' => true
							),
							array(
						...
						sagen_select_icon_collections()->getVCParamsArray( array(), '', true ),
						array(
							array(
								'type'       => 'colorpicker',
								'param_name' => 'color',
								'heading'    => esc_html__( 'Color', 'sagen-core' ),
								'group'      => esc_html__( 'Design Options', 'sagen-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'sagen-core' ),
								'group'      => esc_html__( 'Design Options', 'sagen-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'sagen-core' ),
								'group'      => esc_html__( 'Design Options', 'sagen-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								...
								'heading'     => esc_html__( 'Text Transform', 'sagen-core' ),
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'sagen-core' ),
								'description' => esc_html__( 'Insert padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'sagen-core' ),
								'dependency'  => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'       => esc_html__( 'Design Options', 'sagen-core' )
							)
						)
	...
	public function render( $atts, $content = null ) {
		...
		return sagen_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
	...
	private function getButtonStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			$styles[] = 'font-size: ' . sagen_select_filter_px( $params['font_size'] ) . 'px';
		}
