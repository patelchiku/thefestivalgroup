<button type="submit" <?php sagen_select_inline_style($button_styles); ?> <?php sagen_select_class_attribute($button_classes); ?> <?php echo sagen_select_get_inline_attrs($button_data); ?> <?php echo sagen_select_get_inline_attrs($button_custom_attrs); ?>>
