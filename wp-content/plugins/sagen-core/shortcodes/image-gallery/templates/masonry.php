		...
		<?php foreach ( $images as $image ) { ?>
			...
			if ( ! empty( $image_size_class ) ) {
				...
				if ( $image_size_class === 'large-width-height' ) {
					$new_image_size = 'full';
				} elseif ( $image_size_class === 'small' ) {
					$new_image_size = 'sagen_select_image_square';
				} elseif ( $image_size_class === 'large-width' ) {
					$new_image_size = 'sagen_select_image_landscape';
				} elseif ( $image_size_class === 'large-height' ) {
			...
			<div class="qodef-ig-image qodef-item-space <?php echo esc_attr( $image_classes ); ?>">
				<div class="qodef-ig-image-inner">
					...
					<?php } elseif ( $image_behavior === 'custom-link' && ! empty( $custom_links ) ) { ?>
