<?php
namespace SagenCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'sagen-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'sagen-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'sagen-core' ) => 'grid',
								esc_html__( 'Masonry', 'sagen-core' )    => 'masonry',
								esc_html__( 'Slider', 'sagen-core' )     => 'slider',
								esc_html__( 'Carousel', 'sagen-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'sagen-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'sagen-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'sagen-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'sagen-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'sagen-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'sagen-core' ),
							'value'       => array_flip( sagen_select_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = sagen_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
