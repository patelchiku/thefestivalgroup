<?php
namespace SagenCore\CPT\Shortcodes\Counter;
...
class Counter implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Counter', 'sagen-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Zero Counter', 'sagen-core' )   => 'qodef-zero-counter',
								esc_html__( 'Random Counter', 'sagen-core' ) => 'qodef-random-counter'
							),
							'save_always' => true,
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit',
							'heading'    => esc_html__( 'Digit', 'sagen-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Digit Color', 'sagen-core' ),
							'dependency' => array( 'element' => 'digit', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Title Font Weight', 'sagen-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		wp_enqueue_script( 'counter', SAGEN_CORE_SHORTCODES_URL_PATH . '/counter/assets/js/plugins/counter.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'absoluteCounter', SAGEN_CORE_SHORTCODES_URL_PATH . '/counter/assets/js/plugins/absoluteCounter.min.js', array( 'jquery' ), false, true );
		
		$html = sagen_core_get_shortcode_module_template_part( 'templates/counter', 'counter', '', $params );
	...
	private function getCounterStyles( $params ) {
		...
		if ( ! empty( $params['digit_font_size'] ) ) {
			$styles[] = 'font-size: ' . sagen_select_filter_px( $params['digit_font_size'] ) . 'px';
		}
